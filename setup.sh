...
# Replace 'yourusername' and 'yourpassword' with desired credentials
sudo -i -u postgres bash -c "psql -c \"CREATE USER yourusername WITH PASSWORD 'yourpassword';\""
sudo -i -u postgres bash -c "psql -c \"CREATE DATABASE vlm_db OWNER yourusername;\""

# Set environment variables for PostgreSQL
echo "export DATABASE_URL='postgresql://yourusername:yourpassword@localhost:5432/vlm_db'" >> ~/.bashrc
